...
export const CreateMenuModal = ({ isOpen, onClose, onSave, categories }: CreateMenuModalProps) => {
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-gray-700 focus:border-red-500 focus:ring-2 focus:ring-red-200 transition-all duration-200"
                    >
                        ...
                        {formData.imageUrl ? (
                          <div className="relative inline-block">
                            <img
                              ...
                              alt="Preview"
                              className="mx-auto h-32 w-32 object-cover rounded-lg shadow-md transition-transform duration-200 group-hover:scale-105"
                            />
                            <button
                              type="button"
                              onClick={(e) => {
